		    ...
		    <div class="inputname" v-if="name_input">
		      <div class="name_box">
		        <div class="name_input">
		          <h1>请输入名字</h1>
		          <input type="text" v-model="name" placeholder="12个字以内">
		        </div>
		          ...
		          $(".name_input input").css("color","red")
		           ...
		           return
							...
							$(".name_input input").css("color","#565656")
								...
								setTimeout(()=>{
									window.location.href="/live?roomCode="+this.roomCode+""	
								// window.open("/live?roomCode="+this.roomCode+"")
								// this.$router.push("/live?roomCode="+this.roomCode)
								},500)
